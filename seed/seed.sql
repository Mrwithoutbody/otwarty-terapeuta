...
-- per sekcja (tlo / kadr / skala) z budowniczego układu.
...
UPDATE therapists SET layout_json = '{"theme": "grafit", "display": "duza"}', sections_json = '[{"type": "kluczowe"}, {"type": "intro", "tlo": "panel"}, {"type": "cytat", "body": "To, co powtarza się w relacjach, ma swoją historię. Warto ją poznać.", "author": "Marek Zieliński"}, {"type": "dane", "tlo": "ciemne"}, {"type": "first_meeting"}, {"type": "topics"}, {"type": "offers"}, {"type": "slots"}, {"type": "faq"}, {"type": "credentials"}, {"type": "policy"}, {"type": "zaproszenie", "tlo": "zwykle"}]' WHERE id = 'th_8b2d6e10f4a97c53d1e08b26';
...
UPDATE therapists SET layout_json = '{"theme": "glina", "rhythm": "dostojny"}', sections_json = '[{"type": "kluczowe"}, {"type": "intro", "skala": "duza"}, {"type": "dane", "tlo": "ciemne"}, {"type": "first_meeting"}, {"type": "topics"}, {"type": "offers"}, {"type": "slots"}, {"type": "faq"}, {"type": "credentials"}, {"type": "policy"}, {"type": "zaproszenie"}]' WHERE id = 'th_7a4c2f9051d3e86b4f0a5c18';
...
UPDATE therapists SET layout_json = '{"rhythm": "zwarty"}', sections_json = '[{"type": "kluczowe"}, {"type": "intro", "skala": "duza"}, {"type": "dane", "tlo": "ciemne"}, {"type": "first_meeting"}, {"type": "topics"}, {"type": "offers"}, {"type": "slots"}, {"type": "faq", "kadr": "pas", "tlo": "panel"}, {"type": "credentials"}, {"type": "policy"}, {"type": "zaproszenie"}]' WHERE id = 'th_9f0b4d7382e6a15c7d2b8e34';
UPDATE therapists SET layout_json = '{"theme": "grafit", "bands": "pasy", "display": "duza"}', sections_json = '[{"type": "kluczowe"}, {"type": "intro", "tlo": "ciemne", "skala": "plakat"}, {"type": "dane"}, {"type": "first_meeting"}, {"type": "topics"}, {"type": "offers"}, {"type": "slots"}, {"type": "faq"}, {"type": "credentials"}, {"type": "policy", "tlo": "zwykle"}, {"type": "zaproszenie"}]' WHERE id = 'th_5d8f3b6270e91a4c8b3d0f27';
