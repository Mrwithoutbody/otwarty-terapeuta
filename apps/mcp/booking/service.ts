import { CONFIRMATION_TOKEN_TTL_SECONDS, type Env } from '../../../shared/env';
import { getBookableSlot, getTherapist } from '../../../shared/db/catalog';
import {
  decryptUserEmail,
  getUser,
  recordConsent,
...
import { encryptPii, hmacHex, randomId, randomPublicRef, randomSecret, sha256Hex } from '../../../shared/lib/crypto';
import { AppError, errors } from '../lib/errors';
import { isEmail, isPhone, sanitizeLine } from '../../../shared/lib/sanitize';
import { formatDateTime, formatPrice, hoursBetween, nowIso, timezoneLabel } from '../../../shared/lib/time';
import { signConfirmationToken, verifyConfirmationToken } from '../lib/tokens';
import { enqueueNotification } from '../../../shared/notify/outbox';
import type { ReserveCommand, ReserveResult } from './coordinator';
import { sessionTypeLabel } from '../../../shared/matching/rank';
