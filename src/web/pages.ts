...
<div class="home">
  ...
  <section class="home-section for-you-section" aria-labelledby="for-you-title">
    ...
    <div class="audience-grid">
      <article><img class="audience-art audience-art-first" src="/illustrations/audience-first-step.webp" srcset="/illustrations/audience-first-step-640.webp 640w, /illustrations/audience-first-step.webp 1200w" sizes="(max-width: 64rem) 100vw, 24rem" alt="" width="1200" height="676" loading="lazy" decoding="async"><h3>Jeśli szukasz po raz pierwszy</h3><p>Zrozumiałe informacje pomagają zacząć bez znajomości specjalistycznych pojęć.</p></article>
      <article><img class="audience-art audience-art-choice" src="/illustrations/audience-conscious-choice.webp" srcset="/illustrations/audience-conscious-choice-640.webp 640w, /illustrations/audience-conscious-choice.webp 1200w" sizes="(max-width: 64rem) 100vw, 24rem" alt="" width="1200" height="676" loading="lazy" decoding="async"><h3>Jeśli wiesz, czego potrzebujesz</h3><p>Filtry pozwalają szybko zawęzić wybór do ważnych dla Ciebie kryteriów.</p></article>
      <article><img class="audience-art audience-art-transparency" src="/illustrations/audience-transparency.webp" srcset="/illustrations/audience-transparency-640.webp 640w, /illustrations/audience-transparency.webp 1200w" sizes="(max-width: 64rem) 100vw, 24rem" alt="" width="1200" height="676" loading="lazy" decoding="async"><h3>Jeśli cenisz przejrzystość</h3><p>Ceny, dostępność i zasady odwołania widzisz przed podjęciem decyzji.</p></article>
    </div>
  </section>
